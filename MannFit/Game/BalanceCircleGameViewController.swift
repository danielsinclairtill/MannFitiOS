//
//  BalanceCircleGameViewController.swift
//  MannFit
//
...
class BalanceCircleGameViewController: UIViewController {
...
extension BalanceCircleGameViewController: GameOverPromptDelegate {
    func restartGame() {
        // first dismiss popup
        self.dismiss(animated: true, completion: nil)
...
extension BalanceCircleGameViewController: GameOverDelegate {
